...
const navItems: { value: SidebarTab; icon: React.ElementType; title: string; viewMode: "character" | "network" }[] = [
...
export default function AppSidebar() {
	...
	return (
		<Sidebar variant="inset" collapsible="icon" className="pt-0 z-150 pl-0">
